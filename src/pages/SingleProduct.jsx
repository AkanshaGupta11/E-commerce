...
function SingleProduct() {
    //product/3 --> id ko nikale 
    const params = useParams() ;
    console.log(params); // id mil jayeegi 
    ...
    const getSingleProduct = async () => {
        try{
            ...
            console.log(product) // brand category desc 
        }
        catch(error){
            console.log(error);
        }
            ...
            SingleProduct? <div className='px-4 pb-4 md:px-0'>
                ...
                <div className='max-w-6xl mx-auto md:p-6 grid grid-cols-1 md:grid-cols-2 gap-10'>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <p className='text-xl text-red-500 font-bold flex gap-2'>${SingleProduct.price}
                            <span className='line-through text-gray-700'>${OriginalPrice}</span>
                            <span className='bg-red-500 text-white px-4 py-2 rounded-full'>{SingleProduct.discount}% discount</span>
                        </p>
