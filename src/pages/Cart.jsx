...
//clerk se user detail 
const {user} = useUser(); // fullname wagera sb info mill jaayegi 
console.log(user);
            ...
            {cartItem.map((item,index) => {
              return <div key = {index} className='bg-gray-100 p-5 rounded-md flex items-center justify-between mt-3 w-full'>
                ...
                <div className='bg-red-500 text-white flex gap-4 p-2 rounded-md font-bold text-xl'>
                  ...
                  {/* quantity kr ke kuch nhi hain tho will push by ourselves  */}
           ...
           <div className='grid grid-cols-1 md:grid-cols-2 gap-20'>
            <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
              ...
              <div className='flex flex-col space-y-1'>
                ...
                <input type="text" 
                value = {user?.fullName}
                placeholder = "Enter Your Name" className = "p-2 roundec-md"/>
              </div>
              {/* //address */}
              <div className='flex flex-col space-y-1' >
                <label htmlFor="">Address</label>
                <input type="text" placeholder = "Enter Your Name" className = "p-2 roundec-md"
            ...
            <div className='flex justify-center'>
              <button className='bg-red-500 text-white px-3 py-3 rounded-md'
              onClick={getLocation}>Detect Location</button>
            </div>
            </div>
              ...
              <div className='flex justify-between items-center'>
                ...
                <div className = 'flex justify-between items-center'>
                  ...
                  <p className='text-red-500 font-semibold'>
                    <span className='text-gray-600 line-through'>$25</span>FREE</p>
