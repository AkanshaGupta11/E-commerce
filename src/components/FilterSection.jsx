...
function FilterSection({search, setSearch, brand, priceRange, setPriceRange, category, setCategory,setBrand, handleBrandChange ,handleCategoryChange}) {
  ...
  return (
    <div className='bg-gray-100 mt-10 p-4 rounded-md h-max hidden md:block'>
        ...
        <div className='flex flex-col gap-2'>
            ...
            <input type="range"
            min= '0' max ='5000' className='transition-all' value = {priceRange[1]}
