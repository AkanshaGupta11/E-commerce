    ...
    <div className='space-y-4 mt-2 rounded-md'>
      <div className='bg-gray-100 flex gap-7 items-center p-2 rounded-md'>
        ...
        <div  className='space-y-2'>
          ...
          <p className='text-sm'>FREE delivery <span className='font-semibold'>Fri, 6 August</span> <br />
          Or fastest delivery <span className='font-semibold'>Tomorrow, 5 August</span></p>
